    ...
    return(
       <div className="asideNav">
          <ul className="asideNavList">
             <li><Link to='/' className={ asideDB.home.filter( names => names === hrefName).map((v) => v ? "active" : "")} style={{ backgroundImage: `url(${asideImg01})` }}></Link></li>
             <li><Link to='/' style={{ backgroundImage: `url(${asideImg02})` }}></Link></li>
             <li><Link to='/' style={{ backgroundImage: `url(${asideImg03})` }}></Link></li>
             <li><Link to='/' style={{ backgroundImage: `url(${asideImg04})` }}></Link></li>
             <li><Link to='/' style={{ backgroundImage: `url(${asideImg05})` }}></Link></li>
